...
<section class="hero">
	...
	<a class="chevron" href="#intro" aria-label="Scroll down">
...
<style>
	...
	.hero-scrim {
		position: absolute;
		inset: 0;
		background: linear-gradient(180deg, rgba(0, 0, 0, 0.25) 0%, rgba(0, 0, 0, 0.05) 30%, rgba(0, 0, 0, 0.35) 100%);
	}
	...
	.hero-content h1 {
		...
		font-size: clamp(1rem, 4.75vw, 1.9rem);
		font-weight: 700;
		color: #fff;
		margin: 0 0 0.25rem;
